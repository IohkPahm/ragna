...
> - Ragna có **3 Cantrips** và **8 Spells Prepared Bậc 1–4**.
> - Ngoài ra, Ragna có **1 spell đặc biệt (Revivify)** được nhận từ chiến dịch (Campaign) không tính vào giới hạn prepared spells của Warlock.
> - Tất cả spell slots của Ragna là **Pact Slots Bậc 4** (thi triển tự động upcast lên level 4).
...
| **Spell Attack Bonus** | **+9** (3 PB + 4 CHA + 2 Mortal Wrath Focus) |
| **Pact Magic Slots** | **2** slots (Bậc 4) — hồi phục sau **Short Rest** hoặc **Long Rest** |
...
### 2. Eldritch Blast *(PHB'24 p267)*
- **Casting Time**: 1 Action | **Range**: 120 feet | **Components**: V, S | **Duration**: Instantaneous
- **Hiệu ứng**: Bắn ra **2 luồng tia năng lượng** (2 beams). Mỗi beam roll attack riêng biệt: On hit, gây **1d10 + 4 Force damage** (đã cộng modifier CHA từ *Agonizing Blast*). Có thể nhắm vào cùng 1 target hoặc target khác nhau.

### 3. Chill Touch *(PHB'24 p249)*
- **Casting Time**: 1 Action | **Range**: Touch (Melee spell attack) | **Components**: V, S | **Duration**: Instantaneous
- **Hiệu ứng**: Đòn đánh cận chiến ma pháp. On hit, gây **2d10 Necrotic damage** (cấp 7) và mục tiêu **không thể hồi HP** cho đến cuối lượt sau của bạn.

---

## 🔮 Prepared Spells (8 phép chuẩn bị)

### 1. Shield *(PHB'24 p316 — Hexblade Expanded)*
- **Level 1 Abjuration** | **Casting Time**: 1 Reaction (khi bị hit hoặc bị nhắm bởi Magic Missile) | **Range**: Self | **Duration**: 1 round
...
### 3. Dimension Door *(PHB'24 p262)*
- **Level 4 Conjuration** | **Casting Time**: 1 Action | **Range**: 500 feet | **Components**: V | **Duration**: Instantaneous
- **Hiệu ứng**: Dịch chuyển tức thời đến bất kỳ vị trí nào trong tầm bắn (500 feet). Bạn xuất hiện chính xác tại điểm mong muốn. Điểm này có thể là nơi bạn nhìn thấy, hình dung được, hoặc mô tả bằng khoảng cách và hướng đi (ví dụ: "xuống thẳng 200 feet" hoặc "300 feet hướng tây bắc nghiêng 45 độ").
- Bạn cũng có thể mang theo 1 sinh vật tự nguyện nếu sinh vật đó ở trong khoảng cách 5 feet từ bạn khi bạn dịch chuyển; sinh vật đó sẽ xuất hiện tại vị trí trong vòng 5 feet quanh điểm đến của bạn.
...
### 5. Shining Smite *(PHB'24 p316)*
- **Level 2 Transmutation** | **Casting Time**: 1 Bonus Action (ngay sau khi hit cận chiến) | **Range**: Self | **Components**: V | **Duration**: Conc, up to 1 minute
...
- **Level 3 Abjuration** | **Casting Time**: 1 Reaction (khi thấy creature trong 60ft đang cast spell) | **Range**: 60 feet | **Components**: S | **Duration**: Instantaneous
...
*Xem thêm: [Warlock Class](../character/warlock.md) | [Hexblade Subclass](../character/hexblade.md) | [Eldritch Invocations](../character/invocations.md)*
