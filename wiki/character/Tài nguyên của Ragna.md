...
Feat lv4 (thay cho ISA): Elven Accuracy
XGE
p74
...
Feat Home-brew mà tôi có chỉ của riêng tôi (không có trong sách luật nhưng được chấp nhận)

1. Seed of Life Burst
Life Pulse
	1	Long Rest, bạn có thể thi triển Life Burst mà không tiêu tốn spell slot. Khi dùng theo cách này: Spell được tính là cast ở level 2, 1d8 HP+2d8THP, mỗi đầu R, mục tiêu được hồi 1d4 HP trong vòng 1 phút. Không thể upcast bằng cách này.
	2	Stabilizing Bloom Khi bạn dùng Life Burst bằng feat này: Nếu mục tiêu đang ở 0 HP, nó lập tức: Đứng dậy với số HP được hồi Không bị Prone Có advantage trên saving throw tiếp theo trong 1 round


2. Fractured Form
choing Movement
	•	OA are made disadvantage against you.
Graspless
	•	You have advantage on ability checks to escape grapples or restraints.
Số lần sử dụng = với Proficiency Bonus.

3.leader Inspiration
Khi em phát biểu/phổ biến kế hoạch trc cuộc chiến ít nhất 10 phút. Bạn và 4 Creature sẽ đc nhận 10THP
Cứ mỗi Round, sẽ reset lại 10. Số R duy trì bằng số charisma.


Eldrtich Invocation đang sở hữu
...
Source: PHB'24, page 156. Available in the SRD 5.2.1.
2.Agonizing Blast
PHB'24
p155
...
Source: PHB'24, page 155. Available in the SRD 5.2.1.
3.Devil's Sight
PHB'24
p155
...
Và Origin Feat được nhận sẽ là feat này:
...
Source: FRHoF, page 38


Iteam đang có là 

1. Great Sword - Tên là Mortal Wrath
+2 Weapon: Đòn tấn công với vũ khí này được cộng +2 Attack & Damage rolls.

Wrath Accumulation:

Mỗi khi tấn công thành công, Mortal Wrath tích tụ +1d4 necrotic damage.

Lượng dmg cộng dồn này áp dụng cho tất cả các đòn sau (VD: hit 1: +1d4, hit 2: +2d4, hit 3: +3d4...).

Reset khi miss attack hoặc kết thúc combat.


Critical Grudge: Khi crit, bonus necrotic damage không reset ở lượt tiếp theo, thay vào đó +1d4 ngay lập tức. - Đặc biệt lưu ý cái này chưa mở khóa

Soul’s Toll: Sau combat, nếu Wrath Accumulation đạt từ 6d4 trở lên, người cầm chịu 2d8 necrotic damage (không thể giảm hay kháng).
...
Wondrous Item, Uncommon (Requires Attunement) Một chiếc mặt nạ gỗ trắng, bề mặt như thân cây mục, có những vệt đen như nhựa cây khô. Khi đeo lên, nó hòa tan vào da như sương mù.
	1	Veil of False Skin Bạn có thể dùng Action để thi triển Disguise Self (chỉ thay đổi ngoại hình). Không cần Concentration. Hiệu ứng kéo dài 1 giờ. Có thể sử dụng 2 lần mỗi Long Rest. Khi kích hoạt, mặt nạ hòa vào khuôn mặt bạn.
	2	Surface Echo 1 lần mỗi Short Rest, bạn có thể dùng Bonus Action để đọc ý nghĩ bề mặt của một sinh vật trong phạm vi 30 ft có INT ≥ 6. Chỉ kéo dài 1 round (6 giây). Không đọc được ký ức sâu. Mục tiêu biết có thứ gì đó chạm vào tâm trí (nhưng không biết chính xác bạn là ai).
	3	Dấu Ấn Linh Hồn Mặt nạ bị nguyền rủa. Khi bạn rơi xuống 0 HP, bạn phải thực hiện Wisdom save DC 13. Nếu thất bại, mặt nạ thay đổi khuôn mặt bạn ngẫu nhiên (DM quyết định ngoại hình mới). Nếu bạn chết khi đang attuned, linh hồn bạn bị đánh dấu. Lần đầu tiên bạn được hồi sinh, bạn: Bị thay đổi một đặc điểm chủng tộc nhỏ (mắt, giọng, màu da, tai…) Mất 1 ký ức quan trọng (do DM chọn) Lời nguyền chỉ có thể gỡ bằng Remove Curse hoặc tương đương.

4. Demon Hunter Kimono
Demon Hunter Kimono Wondrous Item, Rare (Requires Attunement) Một bộ kimono đỏ thẫm với họa tiết linh hồn quỷ cháy rực.
	1	Fiendbreaker Mantle Khi mặc kimono, bạn có advantage trên: Saving throws chống lại bị Charmed hoặc Frightened bởi Fiend.
	2	Command Word: Repel Bonus Action. Sinh vật bạn chọn trong cone 30 ft phải thực hiện: Wisdom Save DC = 8 + PB + CHA modifier của bạn Thất bại: Bị Frightened bởi bạn trong 1 phút. Có thể lặp lại save cuối mỗi lượt. Nếu là Fiend: Disadvantage khi save. Nếu thất bại, tốc độ bị giảm còn 0 trong lượt đầu tiên.
	3	Command Word: Hunt (1/Long Rest, chỉ dùng nếu có creature đang Frightened bởi bạn) Bonus Action: Teleport tối đa 30 ft đến ô trống cạnh creature đó. Đòn tấn công đầu tiên bạn gây lên nó trong lượt này gây thêm 2d6 radiant damage. Sau khi dùng, roll d6: Nếu ra 1&2 → không dùng lại tới dawn.
